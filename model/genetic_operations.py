...
def perform_crossover(parent1, parent2):
    if random.random() < Constants.CROSSOVER_RATE.value:
        ...
        child_network.weights1 = np.concatenate(
            (parent1.neural_network.weights1[:crossover_point], parent2.neural_network.weights1[crossover_point:])
        )
        ...
        child_network.weights2 = np.concatenate(
            (parent1.neural_network.weights2[:crossover_point], parent2.neural_network.weights2[crossover_point:])
        )
        ...
        child_network.biases1 = np.concatenate(
            (parent1.neural_network.biases1[:crossover_point], parent2.neural_network.biases1[crossover_point:])
        )
        ...
        child_network.biases2 = np.concatenate(
            (parent1.neural_network.biases2[:crossover_point], parent2.neural_network.biases2[crossover_point:])
        )
